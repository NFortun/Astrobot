...
type GetImagesOK struct {
	...
	/*
	  In: Body
	*/
	Payload models.ImagesResponse `json:"body,omitempty"`
}
...
func (o *GetImagesOK) WithPayload(payload models.ImagesResponse) *GetImagesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get images o k response
func (o *GetImagesOK) SetPayload(payload models.ImagesResponse) {
	o.Payload = payload
}
...
/*
GetImagesDefault default error message
